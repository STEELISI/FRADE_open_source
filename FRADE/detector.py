...
def detect(time1):
        ...
        if (lastDet == 0):
           ...
           if (time1 - lastDet > intDet):
                lastDet = time1
                logging.info("Total_Requests-"+ str(curSeqs))
                ...
                if (curSeqs > attackThresh*avgSeqs and avgSeqs > 0):
                        ...
                        if isAttack and (curSeqs < stopThresh*avgSeqs and curSeqs > 0):
                                ...
                                count_slow_down = count_slow_down + 1
                                if(stop_tb_flag == 0 and count_slow_down > 5):
...
def detect_stop(time1):
        ...
        if (lastDet_PSH == 0):
           ...
           if (time1 - lastDet_PSH > intDet_PSH):
                lastDet_PSH = time1
                logging.info("Successful_Requests-"+ str(curSeqs_PSH)) 
