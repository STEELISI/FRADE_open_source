...
$SYSCTL net.ipv4.tcp_max_syn_backlog=1200000
...
$SYSCTL net.ipv4.tcp_fin_timeout=1
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_close=1
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_close_wait=1
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_fin_wait=1
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_last_ack=1
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_max_retrans=1
...
$SYSCTL net.netfilter.nf_conntrack_tcp_timeout_unacknowledged=1
